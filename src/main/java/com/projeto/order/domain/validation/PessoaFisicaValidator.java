...
public class PessoaFisicaValidator implements ConstraintValidator<PessoaFisicaValid, PessoaFisica> {
    ...
    private List<FieldMessage> existsCpf(List<FieldMessage> list, UUID id, String cpf) {
        PessoaFisica existsCpf = repository.findOne(QPessoaFisica.pessoaFisica.cpf.eq(cpf)).orElse(null);
